...
Color color1 = const Color.fromARGB(255, 255, 249, 221);
Color color2 = const Color.fromARGB(255, 255, 229, 136);
Color color3 = const Color.fromARGB(255, 127, 102, 87);
Color color4 = const Color.fromARGB(255, 72, 59, 54);
Color color5 = const Color.fromARGB(255, 43, 38, 38);
...
class _CreateRecipePageState extends State<CreateRecipePage> {
  ...
  final List<List<TextEditingController>> _ingredientControllers = [[TextEditingController(), TextEditingController()]];
                  ...
                  TextButton(
                    onPressed: () async {
                      if (
                        ...
                        _ingredientControllers.any((list) => list.any((controller) => controller.text.isEmpty)) ||
    ...
    return FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<List<Ingredient>> snapshot) {
            if (snapshot.hasData && snapshot.data!.isNotEmpty) {
              ...
              return Center(
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: MediaQuery.of(context).size.height *0.27),
                  child: Text(
